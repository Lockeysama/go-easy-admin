...
// QueryCount 修改数据
func (c *ManageBaseController) QueryCount(model basemodels.Model, filters map[string]interface{}) (int64, error) {
	o := orm.NewOrm()
...
// QueryList 修改数据
func (c *ManageBaseController) QueryListWithRawFilter(model basemodels.Model, page int, limit int, filters string, loadRel bool) interface{} {
...
// QueryRow 修改数据
func (c *ManageBaseController) QueryRow(model basemodels.Model, filters map[string]interface{}, loadRel bool) interface{} {
