...
// Role 角色
type Role struct {
	ID           int      `orm:"column(id);pk;auto" description:"ID" json:"id" display:"title=ID"`
	...
	CreatedTime  int64    `orm:"auto_now_add" description:"创建时间" json:"created_time" display:"title=创建时间;dbtype=Datetime"`
	UpdatedTime  int64    `orm:"auto_now" description:"修改时间" json:"updated_time" display:"title=修改时间;dbtype=Datetime"`
	Admins       []*Admin `orm:"reverse(many)" description:"角色拥有者" json:"admins" display:"-"`
}
